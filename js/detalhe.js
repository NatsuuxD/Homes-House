...
function atualizarImovel(imovel) {
    ...
    const tituloImv = document.getElementById("nome")
        tituloImv.textContent = imovel.nome 

        const locImv = document.getElementById("loc")
        locImv.textContent = `${imovel.cidade} - ${imovel.estado}`
        ...
        if(adicionais.length == 0){
            ...
            li.textContent="Sem adicionais para imóvel"
            ul.appendChild(li)
